...
int main()
{
	...
	do
	{
		...
		{
			cout << " << Rent a Movie >> " << endl << endl; //Delete
			cout << "Enter a movie code to rent: ";
			cin >> mov.code;
			list.rentMovie(mov.code);
		}
      ...
      cout << "Show Movie Availability" << endl << endl;
